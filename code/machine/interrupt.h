...
#ifndef FILESYS_STUB
    int IntCreateFile(char *filename, int size);
    OpenFileId IntOpenFile(char *name);
    int IntReadFile(char *buf, int size, OpenFileId id);
    int IntWriteFile(char *buf, int size, OpenFileId id);
    int IntCloseFile(OpenFileId id);
#endif
